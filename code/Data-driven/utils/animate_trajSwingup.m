function y = animate_trajSwingup(x1,x2,param)
%
param.Tsim = 3.5;
...
px1_ref = param.l_pivot*sin(0);
px2_ref = px1_ref + param.l_pend*sin(0);
py1_ref = param.l_pivot*cos(0);
...
v = VideoWriter('traj_swingup.avi');
open(v);
tic;     % start timing
